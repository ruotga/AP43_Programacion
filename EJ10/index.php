    ...
    $data = [
        ...
        [
         ...
         foreach($data as $user){
            $FavSeparado = explode(",", $user["Favorites"]);
            $monedencia = null;

            foreach($FavSeparado as $fav){
                if($fav == $Favorites || $fav == " $Favorites"){
                    $monedencia = "existo";
                }
            }

            if(isset($monedencia)){
                echo $user["User"] . " likes " . $Favorites . "<br><br>";
                $i++;
            }
        }
    echo $i . " persons like " . $Favorites;
}
